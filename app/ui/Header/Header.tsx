...
export default function Header() {
  return (
    <>
      <header className='header lg:max-h-[60rem] flex justify-between px-4 lg:px-4 lg:py-9 items-center bg-semiDarkBlue lg:left-0 lg:flex-col lg:w-auto md:rounded-[10px] '>
        <Logo />
